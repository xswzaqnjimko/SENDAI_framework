"""
SENDAI Jr. Quick Demo: Low-frequency pathway only (DA-SHRED).

This demo uses pre-downloaded data from western_us.
Run from the quick_startup/SENDAI_Jr/ directory.

Usage:
    cd quick_startup/SENDAI_Jr
...
def main():
    ...
    print("\n" + "="*70)
    print("SENDAI Jr. Demo (DA-SHRED Only)")
    print("="*70)
