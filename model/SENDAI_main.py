...
LOCATION = 'northwestern_china' # Input target location
...
def main():
    ...
    output_dir = DATA_DIR / LOCATION / ('results' if USE_INR else 'results_INR_off')
    ...
    plot_reconstruction(results_valid, sensor_locs, H, W, output_dir,
                        train_sim.scaler_state, valid_sim.states_scaled, suffix='_valid')
    ...
    plot_reconstruction(results_full, sensor_locs, H, W, output_dir,
                        train_sim.scaler_state, full_sim_states, suffix='_full')
